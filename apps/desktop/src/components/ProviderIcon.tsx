...
function iconClassName(provider: ChatProvider, className?: string): string {
  return ["provider-icon", `provider-icon-${provider}`, className]
    .filter(Boolean)
    .join(" ");
}

/** Official provider marks, matching the icon set used by T3 Code. */
export function ProviderIcon({
  ...
  const sharedProps = {
    ...
    width: size,
    height: size,
    className: iconClassName(provider, className),
    "aria-hidden": true,
  } as const;

  if (provider === "claude") {
    return (
      <svg {...sharedProps} preserveAspectRatio="xMidYMid" viewBox="0 0 256 257">
        <path
          fill="#d97757"
  ...
  if (provider === "codex") {
    return (
      <svg {...sharedProps} preserveAspectRatio="xMidYMid" viewBox="0 0 256 260">
        <path
          fill="#f5f5f5"
  ...
  if (provider === "cursor") {
    return (
      <svg {...sharedProps} viewBox="0 0 466.73 532.09">
        <path
          fill="#edecec"
  ...
  return (
    <svg {...sharedProps} viewBox="0 0 800 800">
